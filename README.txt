...
3) Set remote nodename from Distel to your erblog nodename (test that
the connection is successful by hitting C-c C-d g in Emacs)
4) Load the file deps/elisp/blog.el
5) See file doc/examplepost.el for a barebones example (see all def
functions at the bottom of blog.el for complete list)
6) When you are ready to post, do M-x gms-test-html to make sure your
